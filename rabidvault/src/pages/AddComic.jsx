        ...
        <div className="card" style={{ marginBottom: '1.5rem' }}>
          ...
          {barcodeActive ? (
            <div>
              ...
              <button className="btn btn-outline" style={{ width: '100%', justifyContent: 'center' }} onClick={() => { stopScanner(); setBarcodeActive(false) }}>Stop Camera</button>
            </div>
          ) : (
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                ...
                <button
                  ...
                  onClick={() => {
                    setForm({ title: '', issue_number: '', publisher: '', grade: 'Near Mint', paid_price: '', current_value: '', notes: '', cover_url: '', comicvine_id: '' })
                    setDuplicate(null)
                  }}
                >
                  ✕ Clear Form
